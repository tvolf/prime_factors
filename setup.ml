...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2f7bff8c3360fa2a52702866711bdad4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["tvolf"];
          homepage = None;
          synopsis = "Decomposition to prime factors";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "prime_factors.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "“ÌAG{ã\015b©ıœÀpöD\153";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
